            ...
            render: () => `
                <div style="text-align: center;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 15px;">
                        <div class="glass-panel" style="padding: 15px; border-radius: 12px; border: 1px solid rgba(0,242,254,0.2);">
            ...
            render: () => `
                <div style="text-align: center;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 15px; text-align: left;">
                        <div class="glass-panel" style="padding: 20px; border-radius: 15px; display: flex; align-items: center; gap: 20px;">
